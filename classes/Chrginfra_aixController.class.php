...
class Chrginfra_aixController extends ChrginfraController {
    ...
    function getAutoGenCtrl() {
        ...
        $qform_autogen->addElement('hidden', 'depot', array('value' => $this->depot));
        $qform_autogen->addElement('hidden', 'zspl', array('value' => $this->zspl));
        $qform_autogen->addElement('hidden', 'div', array('value' => $this->div));
