...
class UserRole2CompanyController extends SymfonyBaseController
{
    public function __construct($ladeLeitWartePtr, $container, $requestPtr) {
        parent::__construct($ladeLeitWartePtr, $container, $requestPtr, 'userrole/assignment/company',
            ['fontawesome/css/all.css', 'css/orgchart/jquery.orgchart.css', ''],
            ['js/orgchart/jquery.orgchart.js', 'js/html2canvas.min.js'], 'engg');
        /*Parameters to avoid */
