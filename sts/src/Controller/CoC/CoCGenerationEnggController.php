 ...
 * @Route("/coc-engg")
 */
class CoCGenerationEnggController extends LegacyBaseController
{
    /**
     * @Route("/", methods={"GET"}, name="coc_engg_generation_index")
     * @return Response
     */
    public function index(): Response {
        return $this->render('CoCGeneration/engg.html.twig');
    }

    /**
     * @Route("/pdf/generate-engg", methods={"POST"}, name="engg_generate_coc_pdf")
