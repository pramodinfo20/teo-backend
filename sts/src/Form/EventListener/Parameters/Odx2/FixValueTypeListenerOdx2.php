...
class FixValueTypeListenerOdx2 implements EventSubscriberInterface
{
    ...
    public function onPostSetData(FormEvent $event): void
    {
        ...
        if (in_array($parameter->getType(), [EcuSwParameterTypes::ECU_PARAMETER_TYPE_HW, EcuSwParameterTypes::ECU_PARAMETER_TYPE_PARAMETER] )) {
            switch ($parameter->getLinkingType()) {
    ...
    function changeVisibility(&$form, $variable, $rights)
    {
        ...
        $variableTypes = [
           'valueString',  'valueBlob', 'valueInteger', 'valueUnsigned', 'valueBool', 'linkedToGlobalParameter',
