...
/**
 * DailyStatsUnassigned
 *
 * @ORM\Table(name="daily_stats_unassigned")
 * @ORM\Entity
 */
class DailyStatsUnassigned
{
    /**
     * @var int
     *
     * @ORM\Column(name="daily_stats_unassigned_id", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="SEQUENCE")
     * @ORM\SequenceGenerator(sequenceName="daily_stats_unassigned_daily_stats_unassigned_id_seq", allocationSize=1,
     *                                                                                             initialValue=1)
     */
    private $dailyStatsUnassignedId;
     ...
     * @var float|null
     *
     * @ORM\Column(name="energy_per_100km_soc", type="float", precision=10, scale=0, nullable=true)
     */
     ...
     * @var int|null
     *
     * @ORM\Column(name="hand_break_count", type="integer", nullable=true)
     */
    private $handBreakCount;
     ...
     * @var string|null
     *
     * @ORM\Column(name="hand_break_time", type="string", nullable=true)
     */
    private $handBreakTime;
    ...
    public function getDailyStatsUnassignedId(): ?int
    {
        return $this->dailyStatsUnassignedId;
    }
    ...
    public function setTimestampStart(int $timestampStart): self
    {
    ...
    public function getHandBreakCount(): ?int
    {
        return $this->handBreakCount;
    }

    public function setHandBreakCount(?int $handBreakCount): self
    {
        $this->handBreakCount = $handBreakCount;
    ...
    public function getHandBreakTime(): ?string
    {
        return $this->handBreakTime;
    }

    public function setHandBreakTime(?string $handBreakTime): self
    {
        $this->handBreakTime = $handBreakTime;
