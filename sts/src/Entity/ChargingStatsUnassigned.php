...
/**
 * ChargingStatsUnassigned
 *
 * @ORM\Table(name="charging_stats_unassigned")
 * @ORM\Entity
 */
class ChargingStatsUnassigned
{
    /**
     * @var string
     *
     ...
     * @var float|null
     *
     * @ORM\Column(name="dc_enegery", type="float", precision=10, scale=0, nullable=true)
     */
    private $dcEnegery;
    ...
    public function getDcEnegery(): ?float
    {
        return $this->dcEnegery;
    }

    public function setDcEnegery(?float $dcEnegery): self
    {
        $this->dcEnegery = $dcEnegery;
