...
/**
 * HistoryCocValuesSetsManagement
 *
 * @ORM\Table(name="history_coc_values_sets_management", indexes={@ORM\Index(name="IDX_C8B4ABA671F7E88B", columns={"event_id"}), @ORM\Index(name="IDX_C8B4ABA6DE12AB56", columns={"created_by"})})
 * @ORM\Entity(repositoryClass="App\Repository\HistoryCocValuesSetsManagementRepository")
 */
class HistoryCocValuesSetsManagement
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="history_coc_values_sets_management_h_id_seq", allocationSize=1, initialValue=1)
     */
    private $hId;
     ...
     * @var string|null
     *
     * @ORM\Column(name="before_coc_entity", type="text", nullable=true)
     */
    private $beforeCocEntity;

    /**
     * @var string|null
     *
     * @ORM\Column(name="after_coc_entity", type="text", nullable=true)
     */
    private $afterCocEntity;
    ...
    public function getBeforeCocEntity(): ?string
    {
        return $this->beforeCocEntity;
    }

    public function setBeforeCocEntity(?string $beforeCocEntity): self
    {
        $this->beforeCocEntity = $beforeCocEntity;

        return $this;
    }

    public function getAfterCocEntity(): ?string
    {
        return $this->afterCocEntity;
    }

    public function setAfterCocEntity(?string $afterCocEntity): self
    {
        $this->afterCocEntity = $afterCocEntity;
