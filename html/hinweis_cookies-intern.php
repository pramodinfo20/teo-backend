...
if ($this->user_logged_in) {
    ?>
    <div class="privacyMsg" id="id_privacy2">
        <h3>Hinweis Verwendung von Cookies</h3>
        <p>
        ...
        <p class="privacyButtons">
            <span class="privacyButton" data-msg="Cookies-accept">ich stimme zu</span>
            <span class="LabelX W060">&nbsp;</span>
            <span class="privacyButton" data-msg="Cookies-deny">ich stimme <u>nicht</u> zu</span>
        </p>
    </div>
    <?php
}
