        ...
        tablesorterPager: new function () {
            ...
            var pagerEvents = 'filterInit filterStart filterEnd sortEnd disablePager enablePager destroyPager updateComplete ' +
                ...
                getAjax = function (table, p) {
                    ...
                    if ($('.sts_edited').length | $('.sts_edited_comment').length) { //new change ..
                        var changedfields;
                        $('#edited_data').dialog({
                            modal: true,
                            width: 600,
                            ...
                            resizable: true,
                            buttons: {
                                "Alle Änderungen speichern": function () {
                                    ...
                                    $.ajax({
                                        ...
                                        .done(function (msg) {
                                            ...
                                            continueAjax(table, p);
                                        });

                                    $(this).dialog("close");
                                },
                                "Änderungen werfen": function () {
                                    $(this).dialog("close");
                                    continueAjax(table, p);
                                }
                            }
                    ...
                    } else continueAjax(table, p);


                },

                continueAjax = function (table, p) {
                    ...
                    if (url !== '') {
                        if (!$('.loadingtable').length)
                            $('body').append('<div class="loadingtable" ' +
                                ...
                                'position: absolute;left: 50%;top: 50%; "></div>');
